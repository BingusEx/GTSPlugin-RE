...
namespace GTS {
    ...
    void UIManager::Init() {
        ...
        const auto RenderManager = BSGraphics::Renderer::GetSingleton();
        ...
        const auto DXGISwapChain = reinterpret_cast<IDXGISwapChain*>(RenderManager->GetCurrentRenderWindow()->swapChain);
