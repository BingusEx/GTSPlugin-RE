...
template <> struct fmt::formatter<RE::COL_LAYER>: formatter<string_view> {
	auto format(RE::COL_LAYER v, format_context& ctx) const {
		...
		switch (v) {
			...
			case RE::COL_LAYER::kTransparentSmall: name = "kTransparentSmall"; break;
		    ...
		    case RE::COL_LAYER::kWard: name = "kWard"; break;
			...
			case RE::COL_LAYER::kCameraPick: name = "kCameraPick"; break;
			case RE::COL_LAYER::kItemPick: name = "kItemPick"; break;
			case RE::COL_LAYER::kLOS: name = "kLOS"; break;
			case RE::COL_LAYER::kPathPick: name = "kPathPick"; break;
			case RE::COL_LAYER::kUnused2: name = "kUnused2"; break;
